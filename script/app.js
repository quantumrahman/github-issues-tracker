...
const renderIssue = (issue) => {
    ...
    if (!issue.length) {
        issuesContainer.classList.remove('grid', 'grid-cols-1', 'gap-3', 'md:py-6', 'md:px-6', 'md:grid-cols-2', 'lg:grid-cols-3', '2xl:grid-cols-4');
        issuesContainer.classList.add('min-h-[350px]', 'flex', 'items-center', 'justify-center');

        const p = document.createElement('p');
        p.className = 'font-geist text-xl text-[#64748B]/20 font-semibold md:text-2xl';
        p.textContent = "Issues not found!"
        issuesContainer.appendChild(p);
    } else {
        issuesContainer.classList.remove('min-h-[350px]', 'flex', 'items-center', 'justify-center');
        issuesContainer.classList.add('grid', 'grid-cols-1', 'gap-3', 'md:py-6', 'md:px-6', 'md:grid-cols-2', 'lg:grid-cols-3', '2xl:grid-cols-4');
